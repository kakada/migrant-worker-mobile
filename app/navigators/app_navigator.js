...
import DeleteAccountSuccessScreen from '../screens/delete_account_success';
  ...
  _appStack() {
    return (
      <>
        ...
        <Stack.Screen name="DeleteAccountSuccessScreen" component={DeleteAccountSuccessScreen} options={{ header: null }} />
